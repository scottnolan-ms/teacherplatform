...
const MasteryIcon = ({ level }: { level: number }) => {
  const icons: Record<number, string> = {
    0: '/src/assets/Mastery/Skills/No activity-Fill.svg',
    1: '/src/assets/Mastery/Skills/Earned - 01 - Exploring 0-25.svg',
    2: '/src/assets/Mastery/Skills/Earned - 02 - Emerging 25-50.svg',
    3: '/src/assets/Mastery/Skills/Earned - 03 - Familiar 50-75.svg',
    4: '/src/assets/Mastery/Skills/Earned - 04 Proficient 75-99.svg',
    5: '/src/assets/Mastery/Skills/Earned - 05 Mastered.svg'
  };
