        ...
        <>
          <div className="activity-filter-row">
            <div style={{ display: 'flex', gap: '0.5rem' }}>
              <div className="date-filter">
                <button className="date-filter-btn">
                  <img src="/src/assets/Icons/Calendar.svg" alt="" width="16" height="16" />
            ...
            <button className="btn btn-primary assign-task-btn">
              <img src="/src/assets/Icons/Add.svg" alt="" width="16" height="16" />
              Assign task
            </button>
          </div>
                ...
                <tr>
                  ...
                  <th className="icon-header">
                    <Tooltip content="Skills">
                      <img src="/src/assets/Icons/Outcome-Skill-Star-Fill.svg" alt="Skills" width="16" height="16" className="header-icon skills-icon" />
                    </Tooltip>
                    <span className="header-label">Skills</span>
                  </th>
                  <th className="icon-header">
                    <Tooltip content="Questions">
                      <img src="/src/assets/Icons/Question-Multiple-Angle.svg" alt="Questions" width="16" height="16" className="header-icon questions-icon" />
                    </Tooltip>
                    <span className="header-label">Questions</span>
                  </th>
                  <th className="icon-header">
                    <Tooltip content="Accuracy">
                      <img src="/src/assets/Icons/Target-hit.svg" alt="Accuracy" width="16" height="16" className="header-icon accuracy-icon" />
                    </Tooltip>
                    <span className="header-label">Accuracy</span>
                  </th>
                  <th className="icon-header">
                    <Tooltip content="Points">
                      <img src="/src/assets/Icons/Points.svg" alt="Points" width="16" height="16" className="header-icon points-icon" />
                    </Tooltip>
                    <span className="header-label">Points</span>
                  </th>
                  <th className="icon-header">
                    <Tooltip content="Time spent">
                      <img src="/src/assets/Icons/Time-Taken-acute.svg" alt="Time spent" width="16" height="16" className="header-icon time-icon" />
                    </Tooltip>
                    ...
                    <tr key={student.id}>
                      <td className="student-cell">
                        <div className="student-avatar-wrapper">
                          ...
                          <img
                            src={`/src/assets/Mathspace-Groups/${msGroup}.svg`}
                            alt={msGroup}
                        ...
                        <div className="summary-pills">
                            ...
                            content={
                              <div className="summary-tooltip">
                                ...
                                <div className="tooltip-item">
                                  <img src="/src/assets/Icons/Task-Checkin.svg" width="16" height="16" alt="" />
                                  {activity.studentLedTasks.discoveryCheckins}
                                </div>
                                <div className="tooltip-item">
                                  <img src="/src/assets/Icons/Task-Topic-Readiness-Checkin.svg" width="16" height="16" alt="" />
                                  {activity.studentLedTasks.topicReadinessCheckins}
                                </div>
                                <div className="tooltip-item">
                                  <img src="/src/assets/Icons/Task-Adaptive.svg" width="16" height="16" alt="" />
                                  {activity.studentLedTasks.adaptiveTasks}
                                </div>
                                <div className="tooltip-item">
                                  <img src="/src/assets/Icons/Revision.svg" width="16" height="16" alt="" />
                                  {activity.studentLedTasks.revisions}
                                </div>
                              </div>
                            }
                          >
                            <div className="summary-pill student-led">
                              <img src="/src/assets/Icons/Self-directed.svg" width="16" height="16" alt="" />
                              {studentLedCount}
                            </div>
                          </Tooltip>
                          <Tooltip
                            content={
                              <div className="summary-tooltip">
                                ...
                                <div className="tooltip-item">
                                  <img src="/src/assets/Icons/Task-Custom.svg" width="16" height="16" alt="" />
                                  {activity.teacherAssignedTasks.customTasks}
                                </div>
                                <div className="tooltip-item">
                                  <img src="/src/assets/Icons/Revision.svg" width="16" height="16" alt="" />
                                ...
                                <div className="tooltip-item">
                                  <img src="/src/assets/Icons/Test-mode.svg" width="16" height="16" alt="" />
                                  {activity.teacherAssignedTasks.tests}
                                </div>
                              </div>
                            }
                          >
                            <div className="summary-pill teacher-assigned">
                              <img src="/src/assets/Icons/Teacher.svg" width="16" height="16" alt="" />
                        ...
                        <Tooltip
                          content={
                            <div className="accuracy-tooltip">
                              <div className="tooltip-item">
                                <img src="/src/assets/Icons/Check_circle-Correct-Fill.svg" width="16" height="16" alt="" />
                                {activity.accuracy.correct}
                              </div>
                              <div className="tooltip-item">
                                <img src="/src/assets/Icons/Check-partial.svg" width="16" height="16" alt="" />
                                {activity.accuracy.partial}
                              </div>
                              <div className="tooltip-item">
                                <img src="/src/assets/Icons/Cancel-incorrect.svg" width="16" height="16" alt="" />
                                {activity.accuracy.incorrect}
                              </div>
                              <div className="tooltip-item">
                                <img src="/src/assets/Icons/Skip.svg" width="16" height="16" alt="" />
                      ...
                      <td className="sticky-actions">
                        <div className="sticker-button">
                          <div className="sticker-count">
                            <img src="/src/assets/Icons/Cards_star.svg" width="16" height="16" alt="" />
                            {activity.stickersReceived}
                          </div>
                          <div className="sticker-give">
                            <img src="/src/assets/Pictogram/Stickers.svg" width="24" height="24" alt="" />
                          </div>
                        </div>
                      </td>
                    </tr>
